...
class FollowersUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => FollowersUpdateManyWithoutFollowersItemsInput,
  })
  @ValidateNested()
  @Type(() => FollowersUpdateManyWithoutFollowersItemsInput)
  @IsOptional()
  @Field(() => FollowersUpdateManyWithoutFollowersItemsInput, {
    nullable: true,
  })
...
export { FollowersUpdateInput as FollowersUpdateInput };
